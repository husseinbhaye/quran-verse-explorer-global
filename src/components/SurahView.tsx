  ...
  if (!surah) {
    return (
      <div className="flex-1 p-6 flex items-center justify-center pattern-bg">
        <div className="text-center">
          <h2 className="text-3xl font-['UthmanicHafs'] arabic text-center rtl:text-center mb-4">بِسْمِ اللهِ الرَّحْمٰنِ الرَّحِيْمِ</h2>
    ...
    <div className="flex-1 p-4 md:p-6 overflow-y-auto h-[calc(100vh-12rem)] pattern-bg">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8 geometric-pattern pt-6">
          <h1 className="arabic text-3xl my-4 font-['UthmanicHafs'] text-center rtl:text-center w-full">{surah.name}</h1>
          ...
          <p className="arabic text-xl my-4 font-['UthmanicHafs'] text-center rtl:text-center w-full">بِسْمِ اللهِ الرَّحْمٰنِ الرَّحِيْمِ</p>
        </div>
